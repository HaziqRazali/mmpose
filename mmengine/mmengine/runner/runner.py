...
class Runner:
    ...
    def __init__(
        ...
        # my added stuffs
        # trainable layers
        self.trainable_layers = cfg.get('trainable_layers') 
        self.resume_optimizer = cfg.get('resume_optimizer')
        self.resume_param_scheduler = cfg.get('resume_param_scheduler')
    ...
    def load_or_resume(self) -> None:
        ...
        if self._resume and self._load_from is None:
            ...
            resume_from = self._load_from # 'configs/wholebody_2d_keypoint/rtmpose/cocktail14/rtmw-dw-x-l_simcc-cocktail14_270e-256x192-20231122.pth'

        if resume_from is not None:
            self.resume(resume_from, self.resume_optimizer, self.resume_param_scheduler)
    ...
    def train(self) -> nn.Module:
        ...
        if self.trainable_layers is not None:
            ...
            for name, param in self.model.named_parameters():
                param.requires_grad = any(key in name for key in self.trainable_layers)
    ...
    def resume(self,
        ...
        # this sets self.epoch and self._iter
