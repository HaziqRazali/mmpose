...
def handle_hotkeys_for_presets(args, key: int) -> None:
    ...
    if key == ord(']'):
        ...
        set_kpt_preset(args, 'right_shoulder_flexion')
    elif key == ord('5'):
        set_kpt_preset(args, 'right_shoulder_external_rotation')
    elif key == ord('6'):
        set_kpt_preset(args, 'right_shoulder_internal_rotation')
    elif key == ord('7'):
        set_kpt_preset(args, 'right_knee_flexion')
    elif key == ord('8'):
        set_kpt_preset(args, 'right_knee_extension')
    elif key == ord('9'):
        set_kpt_preset(args, 'right_ankle_dorsiflexion')
    elif key == ord('0'):
        set_kpt_preset(args, 'right_ankle_plantarflexion')
